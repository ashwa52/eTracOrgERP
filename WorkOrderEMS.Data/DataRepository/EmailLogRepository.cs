...
namespace WorkOrderEMS.Data.DataRepository
{
    public class EmailLogRepository : BaseRepository<EmailLog>, IEmailLogRepository
    {
        ...
        public async Task<List<EmailToManagerModel>> SendEmailToManagerForeFleetInspection(long LocationId, long UserId)
        {
            ...
            try
            {
                List<EmailToManagerModel> lstManagers =  (from pd in _workorderEMSEntities.PermissionDetails
                                                         ...
                                                         where mlm.LocationId == LocationId && ur.IsDeleted == false
                                                                && ur.IsDeleted == false
                                                                && (pd.PermissionId == 10 || pd.PermissionId == 428) //eFleet
                                                                 && pd.LocationId == LocationId
                                                         select new EmailToManagerModel
                                                         {
                                                             LocationID = lm.LocationId,
        ...
        /// Created For : List of manager to send mail about urgent work request.
        /// </summary>
        /// <param name="LocationId"></param>
        /// <param name="UserId"></param>
        /// <returns></returns>
        public List<EmailToManagerModel> SendEmailToManagerForUrgentWorkRequest(long LocationID, long UserId)
        {
            List<EmailToManagerModel> obj = new List<EmailToManagerModel>();
            try
            {
        ...
        /// <summary>
        /// Created By : Ashwajit Bansod
        /// Created Date : Sept-28-2018
        /// Created For : List of manager to send mail to approve PO.
        /// </summary>
        /// <param name="LocationID"></param>
        /// <param name="UserId"></param>
        /// <returns></returns>
        public List<EmailToManagerModel> SendEmailToManagerForApprovePO(long LocationID, long UserId)
        {
            List<EmailToManagerModel> obj = new List<EmailToManagerModel>();
            try
            {
                List<EmailToManagerModel> lstManagers = (from pd in _workorderEMSEntities.PermissionDetails
                                                         ...
                                                         where mlm.LocationId == LocationID && ur.IsDeleted == false
                                                                && ur.IsDeleted == false
                                                                && (pd.PermissionId == 11 || pd.PermissionId == 478) //eCounting
                                                                 && pd.LocationId == LocationID
                                                         select new EmailToManagerModel
                                                         {
                                                             LocationID = lm.LocationId,
