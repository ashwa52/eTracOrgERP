...
namespace WorkOrderEMS.Data
{
    public class CommonRepository : ICommonRepository
    {
        ...
        public DashboardCountModel DashboardCountForManager(long UserId, long LocationId)
        {
            var obj = new DashboardCountModel();// sp_GetCountForDashboard_Result();
            try
            {
                 obj = objworkorderEMSEntities.sp_GetCountDashboardForManager(UserId, LocationId).Select(t => new DashboardCountModel()
                 {
                     DarCount = t.DarCount,
                     WorkRequestCount = t.WorkRequestCount,
                     FacilityRequestCount = t.FacilityRequestCount,
                     ContinuousRequestCount = t.ContinuesRequestCount,
                     CompletedContinuesCount = t.CompletedContinuesWO,
                     InProgressContinuesCount = t.ProgressContinuesWO,
                     MissedContinuesWOCount = t.MissedContinuesWO,
