...
namespace WorkOrderEMS.Service
{
    ...
    public class Service : IService
    {
        ...
        private string ImagePath = ConfigurationManager.AppSettings["MiscellaneousImage"];
        private string ImagePathEmeregency = ConfigurationManager.AppSettings["POEmeregencyImage"];
        private string ImagePathPOImage = ConfigurationManager.AppSettings["POImage"];
        #region For Login
        ...
        public ServiceResponseModel<ServiceImageUpload> ImageUpload(ServiceImageUpload objServiceImageUpload)
        {
            ...
            try
            {
                    ...
                    && objServiceImageUpload.ImageModuleName != null)
                {
                    ...
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["QRCParkingFacilityPath"].ToString());
                    ...
                    {
                        WorkOrderImagePath  = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["QRCVehiclePath"].ToString());
                    ...
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["QRCVehicleEnforcementPath"].ToString());
                        ImageUniqueName = DateTime.Now.ToString("yyyyMMddHHmm") + objServiceImageUpload.ImageModuleName + "_" + objServiceImageUpload.UserId;
                    }
                    ...
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["RulesViolationPath"].ToString());
                        ImageUniqueName = DateTime.Now.ToString("yyyyMMddHHmm") + objServiceImageUpload.ImageModuleName + "_" + objServiceImageUpload.UserId;
                    }
                    ...
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["eFleetFueling"].ToString());
                    ...
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["InspectionDocPath"].ToString());
                    ...
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["AttachmentOfMaintenance"].ToString() + "AttachmentMaintenance/");
                        ImageUniqueName = DateTime.Now.ToString("yyyyMMddHHmmsstt") + objServiceImageUpload.ImageModuleName + "_" + objServiceImageUpload.UserId + "InspectionDoc";
                    }
                    #endregion Inspection Doc
                    ...
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["IncidentImage"].ToString());
                    ...
                    #region For Bill Image
                    //Added By Ashwajit Bansod on 12-OCT-2018 for save Bill Image
                    if (objServiceImageUpload.ImageModuleName == "BillImage")
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["BillImage"].ToString());
                    ...
                    #endregion Bill Image

                    #region For Emeregency Image
                    //Added By Ashwajit Bansod on 12-OCT-2018 for save Emeregency Image
                    if (objServiceImageUpload.ImageModuleName == "EmergencyImage")
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["POEmeregencyImage"].ToString());
                        ImageUniqueName = DateTime.Now.ToString("yyyyMMddHHmmsstt") + objServiceImageUpload.ImageModuleName + "_" + objServiceImageUpload.UserId + "POEmeregencyImage";
                        url = HostingPrefix + ImagePathEmeregency.Replace("~", "") + ImageUniqueName + ".jpg";
                    }
                    #endregion Emeregency Image

                    #region For Miscellaneous Image
                    //Added By Ashwajit Bansod on 12-OCT-2018 for save Emeregency Image
                    if (objServiceImageUpload.ImageModuleName == "MiscellaneousImage")
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["MiscellaneousImage"].ToString());
                        ...
                        url = HostingPrefix + ImagePath.Replace("~", "") + ImageUniqueName + ".jpg";
                    }
                    if (objServiceImageUpload.ImageModuleName == "POImage")
                    {
                        WorkOrderImagePath = HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["POImage"].ToString());
                        ImageUniqueName = DateTime.Now.ToString("yyyyMMddHHmmsstt") + objServiceImageUpload.ImageModuleName + "_" + objServiceImageUpload.UserId + "POImage";
                        url = HostingPrefix + ImagePathPOImage.Replace("~", "") + ImageUniqueName + ".jpg";
                    }
                    #endregion Miscellaneous Image
                    ...
                    var ImageLocation = WorkOrderImagePath + ImageURL;
                    //This is use because mobile devloper need to show Miscellaneous
                    ...
                    if (objServiceImageUpload.ImageModuleName == "MiscellaneousImage" || objServiceImageUpload.ImageModuleName == "EmergencyImage" || objServiceImageUpload.ImageModuleName == "POImage")
                    {
        ...
        /// <param name="ObjServiceWorkStatusModel"></param>
        /// <returns></returns>
        public ServiceResponseModelForIdle<string> EmployeeIdleStatus(ServiceWorkStatusModel obj)
        {
            ManageManager ObjManageManager = new ManageManager();
            ServiceResponseModelForIdle<string> ObjServiceResponseModel = new ServiceResponseModelForIdle<string>();
            try
            {
                string replaceString="";
                String replaceTime = "";
                DateTime _now = DateTime.UtcNow.ToUniversalTime();               
                string time = _now.ToString("dd-MM-yyyy HH:mm:ss");
                // var authuser = ObjUserRepository.GetSingleOrDefault(x => x.ServiceAuthKey == ObjWorkStatusModel.ServiceAuthKey && x.UserId == ObjWorkStatusModel.UserId);
                if (obj.LocationID > 0 && obj.UserId > 0)
                {
                    ...
                    if (result != null)
                    {
                        if (result.ResponseTimeForNextIdleCall != null && result.ResponseMessage == "Employee Idle")
                        {
                            string convertToString = Convert.ToString(time);
                            replaceString = convertToString.Replace("/", "-");
                        }
                        else if (result.ResponseTimeForNextIdleCall != null && result.ResponseMessage == "Employee Not Idle")
                        {
                            string convertToString = result.ResponseTimeForNextIdleCall.ToString("dd-MM-yyyy HH:mm:ss");
                            //string convertToString = Convert.ToString(result.ResponseTimeForNextIdleCall);
                            replaceString = convertToString.Replace("/", "-");
                        }
                        replaceTime = time.Replace("/", "-");
                        ...
                        //ObjServiceResponseModel.LastWorkTime = (result != null  && result.ResponseTimeForNextIdleCall != null) ? result.ResponseTimeForNextIdleCall :null;
                        ObjServiceResponseModel.Message = result.ResponseMessage;
                        ObjServiceResponseModel.Response = result.Response;
                        ObjServiceResponseModel.LastWorkTime = ((result.ResponseTimeForNextIdleCall != null) ? replaceString : replaceTime);
                    }
                    else
                    {
                        ObjServiceResponseModel.Message = CommonMessage.SessionExpired();
