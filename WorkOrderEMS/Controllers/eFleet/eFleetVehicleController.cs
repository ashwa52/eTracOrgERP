...
namespace WorkOrderEMS.Controllers.eFleet
{
    public class eFleetVehicleController : Controller
    {
        ...
        public eFleetVehicleController(IEfleetVehicle _IEfleetVehicle, ICommonMethod ICommonMethod)
        {
        ...
        public ActionResult PrePostInspectionDownload(string fn, string inspectiontype)
        {
            try
            {
                ...
                {                                    
                    ...
                    string IsFileExist = RootDirectory + InspectionDocPath;                   
                        ...
                        if (Directory.GetFiles(IsFileExist, fn).Length > 0)
                        {
