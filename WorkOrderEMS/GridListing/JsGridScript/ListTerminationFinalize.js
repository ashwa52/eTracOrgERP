...
var TERFurl = '/TerminationDetaills/SetTerminationFinalizeList';
var base_url = window.location.origin;
// $("#ListTerminationFinalize").jsGrid('loadData');
    var FromDate, ToDate;
    var Tstatus = "F";
        ...
        $("#ListTerminationFinalize").jsGrid({
            ...
            controller: {
                loadData: function (filter) {
                    return $.ajax({
                        type: "GET",
                        url: base_url + TERFurl + "?Todate=" + ToDate + "&FromDate=" + FromDate + "&tstatus=" + Tstatus,
                        datatype: 'json',
            ...
            fields: [
                ...
                { name: "status", title: "Status", css: "text-center", width: 50, },
