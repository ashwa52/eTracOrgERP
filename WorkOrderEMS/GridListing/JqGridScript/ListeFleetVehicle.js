...
$(function () {
    $("#tbl_VehicleList").jqGrid({
        ...
        width: 700,
        autowidth: true,
        colNames: ['QRC Code ID', 'Vehicle Identification No', 'Vehicle No', 'Make', 'Model', 'Fuel Type', 'Vehicle Image', 'GVWR', 'Year', 'StorageAddress','DummyField', 'Actions'],
        ...
        gridComplete: function () {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                if (InspectionStatusFile == null || InspectionStatusFile == "" || InspectionStatusFile == '' || InspectionStatusFile == undefined) {
                    ...
                    insfile = '<a href="' + InspectionDoc + '?Id=' + cl + '" class="download-cloud" title="Inspection file" vid="' + cl + '" style=" float: left;margin-right: 10px;cursor:pointer;"><span class="fa fa-cloud-download fa-2x"></span><span class="tooltips">Inspection</span></a></div>';
                }
