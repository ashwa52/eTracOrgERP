    ...
    $("#tbl_LocationList").jqGrid({
        ...
        gridComplete: function () {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                tr = '<a href="javascript:void(0)" class="qrc" id="treeView" title="CostCode" tid="' + cl + '" style=" float: left;margin-right: 10px;cursor:pointer;"><span class="icon-sitemap fa-2x texthover-greenlight"></span><span class="tooltips">Cost Code</span></a>'
                bd = '<a href="javascript:void(0)" class="qrc" id="budget" title="Budget" bid="' + cl + '" style=" float: left;margin-right: 10px;cursor:pointer;"><span class="icon-dollar fa-2x texthover-bluelight"></span><span class="tooltips">Budget</span></a>'
                ...
                cln = '<a href="javascript:void(0)" class="qrc clientList" title="ClientList" clid="' + cl + '" style=" float: left;margin-right: 10px;cursor:pointer;"><i class="fa fa-user" style="color:#30E7D1;"></i><span class="tooltips">Client</span></a>'
                jQuery("#tbl_LocationList").jqGrid('setRowData', ids[i], { act: be + de + vi + tr + bd + cln });
            }
...
$("#treeView").live("click", function (event) {
    var id = $(this).attr("tid");
    window.location.href = '../GlobalAdmin/TreeView/?loc=' + id;
});
$("#budget").live("click", function (event) {
    var id = $(this).attr("bid");
    window.location.href = '../GlobalAdmin/BudgetAllocation/?loc=' + id;
});
$(".clientList").live("click", function (event) {
    var id = $(this).attr("clid");
