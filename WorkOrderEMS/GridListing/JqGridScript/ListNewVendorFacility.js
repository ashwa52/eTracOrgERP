//$(function () {
//    var act;
//    $("#tbl_AllVendorFacilityDataList").jsGrid({
//        height: "170%",
//        width: "100%",
//        filtering: false,
//        editing: false,
...
//            { name: "ProductServiceName", title: "Product / ServiceName", type: "text", width: 50 },
//            { name: "UnitCostForView", title: "Unit Cost", type: "text", width: 50 },
//            { name: "Tax", title: "Tax", type: "text", width: 50 },
//            { name: "CostCodeDisplay", title: "Costcode", type: "text", width: 50 },
//            //{ name: "ProfileImageFile", title: "ProductImage", type: "imageFormat", width: 50 },
...
//            var ids = jQuery("#tbl_AllVendorFacilityDataList").jsGrid('getDataIDs');
...
//    });
//    if ($("#tbl_AllVendorFacilityDataList").getGridParam("records") > 20) {
//        jQuery("#tbl_AllVendorFacilityDataList").jsGrid('navGrid', '#divAllVendorFacilityListPager', { edit: false, add: false, del: false, search: false, edittext: "Edit" });
//    }
//});
