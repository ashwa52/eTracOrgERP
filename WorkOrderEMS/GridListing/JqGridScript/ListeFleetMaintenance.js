...
var maintenanceDoc = '../eFleetMaintenance/MaintenanceDownload/';
...
$(function () {
    $("#tbl_MaintenanceList").jqGrid({
        ...
        width: 700,
        autowidth: true,
        colNames: ['Vehicle No', 'Maintenance Type', 'Maintenance Date', 'Issue Details', 'Days Out of Services', 'Driver Name', 'Total Cost', 'End Odo.(Miles)', 'Notes', 'MaintenanceAttachment', 'Actions'],
        ...
        { name: 'MaintenanceAttachment', width: 5, sortable: false, hidden: true },
        ...
        gridComplete: function () {
            ...
            for (var i = 0; i < ids.length; i++) {
                var cl = ids[i];
                var rowData = jQuery("#tbl_MaintenanceList").getRowData(cl);
                var MaintenanceStatusFile = rowData['MaintenanceAttachment'];
                ...
                var maintfile = "";
                if (MaintenanceStatusFile == null || MaintenanceStatusFile == "" || MaintenanceStatusFile == '' || MaintenanceStatusFile == undefined) {
                }
                else {
                    maintfile = '<a href="' + maintenanceDoc + '?Id=' + cl + '" class="download-cloud" title="Maintenance file" vid="' + cl + '" style=" float: left;margin-right: 10px;cursor:pointer;"><span class="fa fa-cloud-download fa-2x"></span><span class="tooltips">Maintenance</span></a></div>';
                }
                $("#tbl_MaintenanceList").jqGrid('setRowData', ids[i], { act: be + de + qrc + maintfile }); //+ qrc 
            }
