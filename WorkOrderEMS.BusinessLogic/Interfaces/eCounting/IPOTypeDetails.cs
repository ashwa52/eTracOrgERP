...
namespace WorkOrderEMS.BusinessLogic.Interfaces
{
    public interface IPOTypeDetails
    {
        ...
        List<POTypeDataModel> GetPOTypeDetailsOfCompanyFacilityList(long? UserId, long? LocationID, long? VendorId, int? pageIndex, int? numberOfRows, string sortColumnName, string sortOrderBy);
        string PONumberData();
        ...
        List<POListModel> GetAllPOList(long? UserId, long? LocationId, string status, long? UserTypeId, int? pageIndex, int? numberOfRows, string sortColumnName, string sortOrderBy);
        ...
        List<POTypeDataModel> GetPOFacilityListForEditByPOId(long? UserId, long? POId, int? pageIndex, int? numberOfRows, string sortColumnName, string sortOrderBy);
