...
namespace WorkOrderEMS.Data.DataRepository
{
    public class WorkRequestAssignmentRepository : BaseRepository<WorkRequestAssignment>
    {
        ...
        public List<WorkRequestAssignmentModelList> GetAllWorkRequestAssignment(long? WorkRequestAssignmentID, long? RequestedBy, string OperationName, int? pageIndex, int? numberOfRows, string sortColumnName, string sortOrderBy, string textSearch, long LocationID, long UserID, DateTime StartDate, DateTime EndDate, string Filter, string Filterqrc, ObjectParameter paramTotalRecords)
        {
            List<WorkRequestAssignmentModelList> lstWorkRequest = new List<WorkRequestAssignmentModelList>();
            try
            {
                lstWorkRequest = _workorderEMSEntities.SP_GetAllWorkRequestAssignmentByUsertype(WorkRequestAssignmentID, RequestedBy, OperationName, pageIndex, sortColumnName, sortOrderBy, numberOfRows, textSearch, LocationID, UserID, StartDate, EndDate, Filter, Filterqrc, paramTotalRecords).Select(r => new WorkRequestAssignmentModelList()
                {
                    ...
                    QRCType = r.CodeName,
                    QRCodeID = r.QRCodeID,
                    eFleetVehicleID = r.eFleetVehicleID.ToString()
                    // AssetName = r.QRCName
        ...
        public List<WorkRequestAssignmentModelList> GetAllWorkRequestAssignmentList(long? WorkRequestAssignmentID, long? RequestedBy, string OperationName, int? pageIndex, int? numberOfRows, string sortColumnName, string sortOrderBy, string textSearch, long LocationID, long UserID, DateTime StartDate, DateTime EndDate, string Filter, string Filterqrc,string filterwrtype, ObjectParameter paramTotalRecords)
        {
            List<WorkRequestAssignmentModelList> lstWorkRequest = new List<WorkRequestAssignmentModelList>();
            try
            {
                lstWorkRequest = _workorderEMSEntities.SP_GetAllWorkRequestAssignmentByUsertype_New(WorkRequestAssignmentID, RequestedBy, OperationName, pageIndex, sortColumnName, sortOrderBy, numberOfRows, textSearch, LocationID, UserID, StartDate, EndDate, Filter, Filterqrc, filterwrtype, paramTotalRecords).Select(r => new WorkRequestAssignmentModelList()
                {
                    WorkRequestAssignmentID = r.WorkRequestAssignmentID,
                    WorkRequestType = r.WorkRequestType,
                    WorkRequestTypeName = r.WorkRequestTypeName,
        ...
        public long SaveWorkOrderRequestQRCType(ServiceWorkAssignmentModel ObjServiceWorkAssignmentModel)
        {
            ...
            try
            {
                ObjWorkRequestAssignment.eFleetVehicleID = ObjServiceWorkAssignmentModel.eFleetVehicleID;
