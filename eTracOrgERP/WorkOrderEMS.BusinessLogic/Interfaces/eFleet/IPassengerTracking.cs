...
namespace WorkOrderEMS.BusinessLogic.Interfaces
{
    public interface IPassengerTracking
    {
        ...
        JQGridModel<eFleetPassengerTrackingCountModel> GetListeFleetPassengerCountwithJQGridDetails(int? pageIndex, int? numberOfRows, string sortColumnName, string sortOrderBy, string textSearch, long? statusType);
    }
}
