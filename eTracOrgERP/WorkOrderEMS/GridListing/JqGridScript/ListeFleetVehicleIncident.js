...
$(function () {
    ...
    $("#tbl_IncidentList").jqGrid({
        ...
        width: 700,
        autowidth: true,
        colNames: ['QRCCodeID', 'Vehicle No', 'Driver Name', 'Accident Date', 'Number Of Injuries', 'Number Of Fatalities','Preventability','Incident Description', 'Incident Image','IncidentID', 'Actions'],
       ...
       // { name: 'VehicleIdentificationNo', width: 30, sortable: true },
        ...
        { name: 'NumberOfFatalities', width: 30, sortable: false},
        { name: 'Preventability', width: 25, sortable: true },
        { name: 'Description', width: 40, sortable: true },   
        { name: 'IncidentImage', width: 15, sortable: false, hidden: true },
