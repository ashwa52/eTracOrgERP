...
$(function () {
    $("#tbl_DriverList").jqGrid({
        ...
        caption: '<div class="header_search"><input id="SearchText" class="inputSearch" placeholder="Search by Driver License No & Driver Name" style="width: 260px;" onkeydown="doSearch(arguments[0]||event)" type="text">&nbsp;' + vehcileApprovalStatus + '&nbsp;</div>'
...
function gridReload() {
    ...
    jQuery("#tbl_DriverList").jqGrid('setGridParam', { url: $_HostPrefix + DriverUrl + "?txtSearch=" + txtSearch.trim() + "&statusType=" + statusType + "&LocationID=" + $_locationId, page: 1 }).trigger("reloadGrid");
}
