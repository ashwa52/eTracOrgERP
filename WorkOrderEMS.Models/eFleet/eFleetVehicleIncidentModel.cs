   ...
   public class eFleetVehicleIncidentModel
    {
        ...
        [Required(ErrorMessage = "Accident time is required")]
        ...
        [Required(ErrorMessage = "Number of Fatalities is required")]
        [RegularExpression("^[0-9 ]+$", ErrorMessage = "Special characters and Letters are not allowed.")]
    ...
    public class eFleetReportIncidentDetails : eFleetVehicleIncidentModel
    {
