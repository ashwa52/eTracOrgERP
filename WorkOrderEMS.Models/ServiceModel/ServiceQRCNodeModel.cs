...
namespace WorkOrderEMS.Models
{
    ...
    public class TrashcanTrashRemoval
    {
        ...
        public int OldTrashLevels { get; set; }
        [DataMember]
        public bool IsTrashRemovalComplete { get; set; }       
    }
    #endregion TrashCan
    ...
    public class ShuttleDamage
    {
        ...
        [DataMember]
        public bool IsDamageClicked { get; set; }
        [DataMember]
        public long DamageWorkOrderId { get; set; }
    }
    [DataContract, KnownType(typeof(ServiceQrcShuttleBusModel))]
    public class ShuttleMileage
    {
        [DataMember]
        public bool IsChShuttleMileageClicked { get; set; }
        [DataMember]
    ...
    public class Interior
    {
        ...
        public bool IsClean { get; set; }
        [DataMember]
        public bool IsCleanClicked { get; set; }
        [DataMember]
        public int CleanDarId { get; set; }
        [DataMember]
    ...
    public class Tires
    {
        ...
        [DataMember]
        public bool IsFrontWheelAssemblyClicked { get; set; }
        ...
        [DataMember]
        public bool IsRearWheelAssemblyClicked { get; set; }


        [DataMember]
        public bool IsTireDamage { get; set; }
        [DataMember]
        public bool IsTireDamageClicked { get; set; }
        [DataMember]
    ...
    public class Emergency
    {
        ...
        [DataMember]
        public bool IsLiftOperationClicked { get; set; }
        [DataMember]
        ...
        [DataMember]
        public bool IsDoorWarningClicked { get; set; }
        [DataMember]
        public long DoorWarningWorkOrderId { get; set; }
        [DataMember]
        public bool IsPostedDecals { get; set; }
        [DataMember]
        public bool IsPostedDecalsClicked { get; set; }
        [DataMember]
