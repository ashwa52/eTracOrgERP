...
namespace WorkOrderEMS.Helper
{
    ...
    public static class CommonMessage
    {
        ...
        public static string HOSEmployeeNotAbleToWork()
        {
            return "Please End Your Shift.";
        }
        public static string AlreadyContinuesWOComplete(string ConString)
        {
            return "This"+" "+ ConString +"" +" work has been already completed.";
        }
        public static string AlreadyContinuesWOStart(string ConString)
        {
            return "This" + " " + ConString + " " + "work is in progress.";
        }
        public static string CostCodeCheckedNodeSaved()
        {
            return "Checked cost code saved successfully.";
        }
        public static string CostCodeCheckedNodeNotSaved()
        {
            return "Error occure while saving.";
        }
        public static string CostCodeSaved()
        {
            return "Cost Code Saved Successfully.";
        }
        public static string POSaved()
        {
        ...
        public static string PORemoved()
        {
            return "PO Removed Successfully.";
        }
        public static string POSelfApprove()
        {
            return "This PO is self approved by you successfully.";
        }
        public static string POApprovedFailure()
        {
            return "PO Approved Failure.";
        }
        public static string SendMailForBudget()
        {
            return "Mail sent successfully.";
        }
        public static string FailureSendMailForBudget()
        {
            return "Mail Failed.";
        }
        public static string BillSaved()
        {
            return "Bill Saved Successfully.";
        }
        public static string BillApprove()
        {
            return "Bill approved Successfully.";
        }
        public static string BillReject()
        {
            return "Bill reject.";
        }
        public static string VendorApprove()
        {
        ...
        {
            return "Vendor save successfully.";
        }
        public static string VendorFailure()
        {
            return "Something went wrong while saving Company";
        }
        public static string ApproveMiscellaneous()
        {
            return "Approve successfully.";
        }
        public static string ErrorMiscellaneous()
        {
            return "Error while approve miscellaneous.";
        }
        ...
        public static string PONumberNotExist()
        {
            return "The PO number does not exist.";
        }
        public static string PONumberIsNotApprove()
        {
            return "The PO number is not approved.";
        }
        public static string CompanyAlreadySaved()
        {
            return "Quickbook already configured with company no more company added.";
        }
        ...
        public static string WOStatusMessageForManager(string WOId)
        {
            return "The Work Order"+ " " + WOId + " " + "is Created and not Accepted by any user." ;
        }
        public static string CheckInOutStatus()
        {
            return "This QRC is already checked out by other user.";
        }
        public static string CheckInOutMessageForManager(string FirstName, string LastName, string QRCID, string UserName)
        {
